...
logger = logging.getLogger('BatDongSanTransformer')

class BatDongSanTransformer:
    """
    ...
    def __init__(self):
        self.source_id = "batdongsan.com.vn"
    ...
    def _is_valid_listing(self, listing_data: Dict[str, Any]) -> bool:
        ...
        area_value = listing_data.get('area_value')
    ...
    def _transform_raw_property_details(self, listing: Dict[str, Any], listing_id: str) -> Dict[str, Any]:
        ...
        floors = details.get('floors', listing.get('floors', ''))
    ...
    def _transform_raw_contact_info(self, listing: Dict[str, Any], listing_id: str) -> Dict[str, Any]:
        ...
        contact_name = self._clean_text(contact.get('name', ''))
        contact_phone = contact.get('phone', '')
        contact_address = self._clean_text(contact.get('address', ''))
