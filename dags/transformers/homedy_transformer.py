...
class HomedyTransformer:
    ...
    def _is_valid_listing(self, listing_data: Dict[str, Any]) -> bool:
        ...
        area_value = listing_data.get('area')
    ...
    def _transform_property_listing(self, listing: Dict[str, Any], bds_id: str = "") -> Dict[str, Any]:
        ...
        area_text = listing.get('area_text', '') or listing.get('area', '')
        area_value = self._extract_area(area_text)
        
        # Calculate price per m²
        price_per_m2_value = listing.get( 'price_per_m2','')
        ...
        post_date = self._format_date(listing.get('post_date', ''))
        expiration_date = self._format_date(listing.get('expiration_date', ''))
    ...
    def _transform_raw_property_details(self, listing: Dict[str, Any], listing_id: str) -> Dict[str, Any]:
        ...
        bathrooms = details.get('bathrooms') or {}
        ...
        floors = details.get('floors', listing.get('floors') or '')
        ...
        raw_legal_status = details.get('legal_status') or {}
    ...
    def _transform_raw_contact_info(self, listing: Dict[str, Any], listing_id: str) -> Dict[str, Any]:
        ...
        contact = listing.get('contact', {}) or listing or {}
    ...
    def _transform_raw_property_amenities(self, listing: Dict[str, Any], listing_id: str) -> List[Dict[str, Any]]:
        ...
        # Extract amenities from amenities field (nếu có và là list)
        if 'amenities' in listing and isinstance(listing['amenities'], list):
            for amenity in listing['amenities']:
                amenity_data = {
                    ...
                    'amenity_category': 'Tiện ích nội thất',
                    'amenity_description': '',
                    'amenity_value': '',
        ...
        # Extract additional amenities from details (nếu có)
        ...
        for key, value in details.items():
            ...
            if value:  # Only add if there's a value
                amenity_data = {
                    ...
                    'source_id': self.source_id,
                    'amenity_name': key,
                    'amenity_category': 'Đặc điểm bất động sản',
                    'amenity_description': '',
                    'amenity_value': str(value),
        ...
        for keyword in self.amenities_keywords:
            if keyword.lower() in description:
                ...
                if not any(am['amenity_name'].lower() == keyword.lower() for am in amenities_list):
                    amenity_data = {
                        'listing_id': listing_id,
                        'source_id': self.source_id,
